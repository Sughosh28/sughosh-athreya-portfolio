...
const criblSvg = <img src="/cribl.png" alt="Cribl" />;
const htmlSvg = (
  <img
    width="48"
    height="48"
...
const intelliJSvg = (
  <img
    width="48"
    height="48"
    src="https://img.icons8.com/color/48/intellij-idea.png"
    alt="intellij-idea"
  />
);
...
const skillsData = [
  {
    ...
    items: [
      { id: "pl1", name: "Java", svg: javaSVG },
      { id: "pl2", name: "JavaScript", svg: jsSVG },
    ],
  },
  {
    category: "Frontend Technologies",
    items: [
      { id: "ft1", name: "HTML", svg: htmlSvg },
      { id: "ft2", name: "CSS", svg: cssSVG },
      { id: "ft3", name: "Tailwind CSS", svg: tailwindSvg },
    ],
  },
  {
    category: "Frameworks & Libraries",
    items: [
      { id: "fw1", name: "Spring Boot", svg: springBootSVG },
      { id: "fw2", name: "Hibernate", svg: hibernateSvg },
      { id: "ft3", name: "React JS", svg: reactSVG },
    ],
  },
  {
    category: "Databases",
    items: [
      { id: "db1", name: "MySQL", svg: sqlSVG },
      { id: "db2", name: "PostgresQL", svg: postgresvg },
    ],
  },
  {
    category: "Version Control",
    items: [{ id: "vc1", name: "Git", svg: gitSvg }],
  },
  {
    category: "Tools",
    items: [
      { id: "t1", name: "Github", svg: githubSvg },
      { id: "t2", name: "IntelliJ IDEA", svg: intelliJSvg },
...
const Skills = () => {
  return (
    <section
      id="skills"
      className="py-16 bg-gradient-to-b from-slate-950 via-gray-900 to-black min-h-[75vh] relative "
    >
      <div className="absolute inset-0 bg-grid-white/[0.02] -z-0 " />
      <div className="absolute h-full w-full">
        <div className="absolute top-0 left-0 right-0 bg-gradient-to-b from-slate-950 to-transparent h-12 z-10" />
      </div>

      <div className="container mx-auto px-4 md:px-8 max-w-7xl relative z-20 ">
        <div className="text-center mb-20">
          <h2 className="text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-blue-500">
            Skills & Expertise
          </h2>
        </div>
        ...
        {skillsData.map((category) => (
          <div key={category.category} className="mb-10">
            <h3 className="text-3xl font-bold text-gray-200 mb-10 ml-4 flex items-center">
              <span className="mr-3 h-px w-8 bg-gradient-to-r from-teal-400 to-transparent" />
              {category.category}
            </h3>
              ...
              {category.items.map((item) => (
                <div
                  ...
                  className="group flex flex-col items-center p-2 rounded-lg
                             ...
                             border border-slate-700/30 hover:border-teal-500/40
                             transition-all duration-300 hover:scale-105"
                >
                  <div className="w-10 h-10 mb-2">{item.svg}</div>
                  <span
                    className="text-sm font-medium text-gray-300 group-hover:text-teal-400
                  ...
                  <div
                    className="absolute inset-0 bg-teal-500/5 rounded-lg opacity-0 
