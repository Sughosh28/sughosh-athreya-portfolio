...
const skillsData = [

  {
    id: '1',
    name: "Java",
    description: "Expertise in Java programming and OOP concepts.",
    svg: javaSVG,
  },
  {
    id: '2',
    name: "Spring Boot",
    description: "Developing scalable web applications using Spring Boot.",
    svg: javaSVG,
  },
  {
    id: '3',
    name: "Hibernate, Servlets & JSP",
    description: "Utilizing Hibernate for ORM in Java applications and building web applications using Servlets and JSP for dynamic content.",
    svg: javaSVG,
  },
  {
    id: '4',
    name: "MySQL & PostgreSQL",
    description: "Strong understanding of relational databases, SQL, and experience with advanced database features and performance tuning.",
    svg: sqlSVG,
  },
  {
    id: '5',
    name: "CSS and Tailwind CSS ",
  ...
  },
  {
    id: '6',
    name: "Python",
    description: "Experience in scripting, data analysis, and web frameworks.",
    svg: pythonSVG,
  },
  {
    id: '7',
  ...
  },
  {
    id: '8',
    name: "React JS",
    description: "Experienced in developing interactive and scalable web applications using React.js, leveraging hooks, state management, and modern frontend tools.",
    svg: reactSVG,
  },
];
