const HeroSection = () => {
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-b from-slate-950 via-gray-900 to-black"
    >
        ...
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-16">
          ...
          <div className="lg:w-1/2 flex justify-center items-center">
            <div className="relative group perspective-1000">
              <div
                className="absolute -inset-1.5 bg-gradient-to-r from-slate-700 to-slate-800 rounded-full blur-md opacity-75 
                            group-hover:opacity-100 group-hover:blur-lg transition-all duration-500"
              ></div>
